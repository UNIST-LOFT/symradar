...
private:
  ...
  void executeMakeSymbolic(ExecutionState &state, const MemoryObject *mo,
                           const std::string name, bool existing = true);
  ...
  ref<klee::ConstantExpr> toConstant(ExecutionState &state, ref<Expr> e,
                                     const char *purpose,
                                     bool addToConstraint = true);

  /// Bind a constant value for e to the given target. NOTE: This
  /// function may fork state if the state has multiple seeds.
  void executeGetValue(ExecutionState &state, ref<Expr> e,
                       KInstruction *target);
  void executeUniKleePocChoice(ExecutionState &state, KInstruction *target);
  ...
  ref<Expr> getConcreteValue(ExecutionState &state, ref<Expr> e);
...
public:
  ...
  std::string getConsistentName(ExecutionState &state, std::string prefix,
