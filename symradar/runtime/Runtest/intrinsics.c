...
void uni_klee_make_symbolic(void *array, size_t nbytes, const char *name) {
...
void extractfix_make_symbolic(void *array, size_t nbytes, const char *name) {
  uni_klee_make_symbolic(array, nbytes, name);
}

void uni_klee_restore_concrete(void *array, size_t nbytes) {
}
