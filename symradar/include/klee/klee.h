...
void uni_klee_make_symbolic(void *addr, size_t nbytes, const char *name);
void extractfix_make_symbolic(void *addr, size_t nbytes, const char *name);

void uni_klee_restore_concrete(void *addr, size_t nbytes);

void uni_klee_add_patch(void *addr, int patch_id, int result);
